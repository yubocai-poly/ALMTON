...
#     # Define a simple test function (e.g., Himmelblau's function)
#     def fx(X):
#         x = X[0, 0]
#         y = X[1, 0]
...
#     max_iterations = 100
#     tol = 1e-6
#     param_list = [0.1, 0.1, 0.1, 2.0]  # [c, l, eta, gamma]

#     # Run the algorithm
#     x_final, iterations = ar3_run(fx, dx, d2x, d3x, x0, max_iterations, tol, param_list)
#     print(f"Final point: {x_final.flatten()}")
